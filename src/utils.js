...
const niceColors = ["#012169", "#d883ff", "#9336fd", "#1be7ff", "#6eeb83", "#e4ff1a", "#e8aa14", "#ff5714", "#f94144", "#f050ae", "#f3722c", "#f8961e", "#f9844a", "#f9c74f", "#90be6d", "#43aa8b", "#4d908e", "#577590", "#277da1", "#33a8c7", "#52e3e1", "#a0e426", "#fdf148", "#ffab00", "#f77976"]
...
const fixedColors = (length) => niceColors.concat(niceColors.concat(niceColors)).slice(0, length)
